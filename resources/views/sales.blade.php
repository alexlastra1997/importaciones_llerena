                ...
                <div class="bg-white dark:bg-gray-800 relative sm:rounded-lg overflow-hidden shadow-2xl">
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                        <div class="flex-1 flex items-center space-x-2">
                            <h3 class="text-2xl font-semibold text-blue-900">Todos las Ventas</h3>
                        </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                <tr>
                                    <th scope="col" class="p-4">Clientes</th>
                                    <th scope="col" class="p-4">Ciudad</th>
                                    <th scope="col" class="p-4">Fecha de Venta</th>
                                    <th scope="col" class="p-4">Monto Vendido</th>
